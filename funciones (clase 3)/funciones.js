...
// Dont repeat yourself, keep it simple stupid, if you are not going to need it, delete it
...
// let devolverValor = retornarString()
...
let producto = 5;
let cantidadDisponible = 3;
const maximaCapacidad = 10;
let resta = producto - 3;
alert("La cantidad disponible de producto es " + resta);